...
\Problema{3}{Análisis de Circuitos con Transformada de Laplace}
\vspace{2mm}
...
\begin{subpunto}
\item Obtenga una expresión para la corriente en el condensador $I_C$ en el dominio $s$. Simplifique al máximo. \partialPoints{1.5}.
...
\item Obtenga la expresión para la corriente en el condensador $i_C(t)$ en el dominio temporal. Simplifique al máximo. \partialPoints{0.5}.
...
\item Esboce la gráfica de $i_C(t)$. Utilice como escala horizontal $1\,cm=25\,\mu s$ y escala vertical $1\,cm=1\,A$.\partialPoints{1}.
