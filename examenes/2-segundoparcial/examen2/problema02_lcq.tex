...
\Problema{3}{Respuesta en Frecuencia y Filtros}
\vspace{2mm}
...
\begin{subpunto}
  \item Encuentre la función de respuesta en frecuencia  $\phr{H}(\omega)$ de este circuito como función de $C$ y $R$, tomando $\phr{V}_s$ como entrada y $\phr{V}_o$ como salida. Debe desarrollar su respuesta hasta llegar a una división de polinomios. \partialPoints{1}
  ...
  \item Encuentre la respuesta en magnitud para este filtro. \partialPoints{0.5}
  ...
  \item Calcule el valor máximo de ganacia en decibeles para este filtro. \partialPoints{0.5}
...
\solution{  
  ...
  \item Si se definen los valores de $C=1m$F y $R=1k\Omega$, encuentre las frecuencias de corte y el ancho de banda para el filtro, todas en $rad/s$.\partialPoints{1}
