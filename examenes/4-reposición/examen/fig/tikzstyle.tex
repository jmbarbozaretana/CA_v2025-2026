...
\usepackage[outline]{contour}           % draw outline around text
\contourlength{1pt}                     % set contour thickness
...
\newlength\syslinewidth
\setlength\syslinewidth{0.75pt}

\tikzset{
    >=latex,
    ultra thin/.style= {line width=0.125\syslinewidth},
    very thin/.style=  {line width=0.25\syslinewidth},
    thin/.style=       {line width=0.5\syslinewidth},
    semithick/.style=  {line width=\syslinewidth},
    thick/.style=      {line width=2\syslinewidth},
    very thick/.style= {line width=4\syslinewidth},
    ultra thick/.style={line width=8\syslinewidth},
