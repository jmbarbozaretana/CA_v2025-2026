...
Considere el circuito de la siguiente figura, que corresponde a un filtro pasa banda donde se sabe que su frecuencia central está definida por $\dfrac{1}{RC}$:
