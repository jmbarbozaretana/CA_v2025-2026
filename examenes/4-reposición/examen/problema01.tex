...
\Problema{10}{Análisis de Potencia en CA}
...
\begin{center}
  \includegraphics[scale=1]{prob01_lcq}
\end{center}


\begin{subpunto}
	\item Encuentre el valor que debe tener la impedancia de carga $\mathbf{Z}_L$ para lograr la máxima transferencia de potencia para esta carga. \partialPoints{4}
	...
	\begin{center}
		\includegraphics[scale=1]{prob01_lcq - sol_a}
	\end{center}
	...
	\item Calcule el valor de la potencia máxima lograda para el valor de $\mathbf{Z}_L$ calculado. \partialPoints{4}
	...
	\begin{center}
		\includegraphics[scale=1]{prob01_lcq - sol_b}
	\end{center}
	...
	\item Si se sabe que la fuente de tensión independiente opera a $120\,$Hz, defina cuál o cuáles componentes (R, L, C o mezclas) pueden formar parte de $\mathbf{Z}_L$ considerando el valor obtenido para lograr la máxima transferencia de potencia. Encuentre además el valor físico de estos componentes. \partialPoints{2}
	
	\solution{
	
	Dado que $\mathbf{Z}_{L}$ debe ser $2.5+2.5j\,\Omega$ se desglosa que esta está compuesta de una resistencia y una bobina en serie. La $R$ sería la parte real $2.5\,\Omega$ \calif{1 Punto}. La reactancia de la bobina sería: 
	
	\begin{eqnarray*}
		j\omega L&=&2.5j\\
		L&=&\dfrac{2.5}{2\pi 120}= 3.31\,mH \calif{1 Punto}
	\end{eqnarray*} 
	}
