...
\begin{subpunto}
	...
	\begin{center}
		\includegraphics[scale=1]{prob04_sol}
	\end{center}
	...
	\begin{eqnarray*}
		...
		\\
		&=&\dfrac{\mathbf{V}_s(j20\pi n)}{4+j30\pi n}=\dfrac{\mathbf{V}_s(20\pi n\angle(90^o))}{\sqrt{4^2+(30\pi n)^2}\angle\tan^{-1}(30\pi n/4)}\\
		&=&	\mathbf{V}_s \dfrac{j20\pi n}{\sqrt{16+900(\pi n)^2}}	\angle (90^o-\tan^{-1}(15\pi n/2))
	\end{eqnarray*}
	...
	Y por lo tanto:
	\begin{align*}
		\mathbf{V}_o&=\left(\dfrac{\sqrt{A^2+B^2}}{n}\angle \tan^{-1}\left(\dfrac{B}{A}\right)\right)\dfrac{j20\pi n}{\sqrt{16+900(\pi n)^2}}	\angle (90^o-\tan^{-1}(15\pi n/2))\\
		&=\dfrac{\sqrt{A^2+B^2}(j20\pi)}{\sqrt{16+900(\pi n)^2}}	\angle (\tan^{-1}(B/A)+90^o-\tan^{-1}(15\pi n/2))
	\end{align*}
	...
	\begin{align*}
		v_o(t)&=\dfrac{\sqrt{A^2+B^2}(j20\pi)}{\sqrt{16+900(\pi n)^2}}\cos\left(2\pi nt+\tan^{-1}(B/A)+90^o-\tan^{-1}(15\pi n/2)\right) 
	\end{align*}
	\calif{1 Pto}
	}
	...
	\begin{center}
		\includegraphics[scale=1]{prob04_espectroAmp}\\
		\includegraphics[scale=1]{prob04_espectroFase}\\
	\end{center}
...
Encuentre los valores de $A$ y $B$, y exprese $v_s(t)$ incorporando los valores encontrados.  \partialPoints{4}
	...
	Finalmente, la expresión final de $v_o(t)$ sería:
	\begin{align*}
		v_o(t)&=\dfrac{\sqrt{\pi^4+4\pi^2}(j20\pi)}{\sqrt{16+900(\pi n)^2}}\cos\left(2\pi nt+\tan^{-1}(2/\pi)+90^o-\tan^{-1}(15\pi n/2)\right) 
	\end{align*}
	\calif{1 Pto}
